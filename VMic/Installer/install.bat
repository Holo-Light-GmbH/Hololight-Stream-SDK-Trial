...
if '%errorlevel%' NEQ '0' (
    echo Requesting administrative privileges for installing ISARVirtualMicrophone...
    goto UACPrompt
) else ( goto gotAdmin )
...
ENDLOCAL
ECHO Installing ISARVirtualMicrophone device.....
DEVCON INSTALL ISARVirtualMicrophone.inf Root\ISARVirtualMicrophone
GOTO PMessage
