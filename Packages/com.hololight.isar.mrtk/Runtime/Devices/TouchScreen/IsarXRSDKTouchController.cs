...
{ 
	/// <summary>
	/// MRTK Touch Controller implementation for ISAR Touch Support
	/// </summary>
	[MixedRealityController(
		SupportedControllerType.TouchScreen,
		new[] { Handedness.Any })]
	public class IsarXRSDKTouchController : BaseController
	{
		public IsarXRSDKTouchController(TrackingState trackingState, Handedness controllerHandedness, IMixedRealityInputSource inputSource = null, MixedRealityInteractionMapping[] interactions = null)
		...
		private static readonly ProfilerMarker UpdatePerfMarker = new ProfilerMarker("[MRTK] IsarXRSDKTouchController.Update");
		...
		private static readonly ProfilerMarker EndTouchPerfMarker = new ProfilerMarker("[MRTK] IsarXRSDKTouchController.EndTouch");
