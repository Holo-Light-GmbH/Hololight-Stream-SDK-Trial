...
// Copyright (c) Holo-Light GmbH. All rights reserved.
...
{
	public class IsarWindowsMixedRealityArticulatedHandDefinition : ArticulatedHandDefinition
	{
		public IsarWindowsMixedRealityArticulatedHandDefinition(IMixedRealityInputSource source, Handedness handedness) : base(source, handedness)
		{
			inputSource = source;
			this.handedness = handedness;
		}

		private new readonly IMixedRealityInputSource inputSource;
		private new readonly Handedness handedness;
		...
		/// </summary>
		public new bool IsInPointingPose
		{
			get
			{
		...
		public new void UpdateHandJoints(Dictionary<TrackedHandJoint, MixedRealityPose> jointPoses)
		{
			unityJointPoses = jointPoses;
			CoreServices.InputSystem?.RaiseHandJointsUpdated(inputSource, handedness, unityJointPoses);
		}

		public new void UpdateCurrentIndexPose(MixedRealityInteractionMapping interactionMapping)
		{
